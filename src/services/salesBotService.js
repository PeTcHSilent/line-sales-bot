...
"คำถามอื่นๆ เดี๋ยวน้องต่อกันติดต่อเจ้าหน้าที่ให้สักครู่นะครับ 🐾"
...
- หากลูกค้าถามว่าเมื่อไหร่ได้รับกรมธรรม์ / กรมธรรม์ออกเมื่อไหร่ ให้ตอบว่า:
  "กรมธรรม์จะออกภายใน 14 วันทำการครับ ไม่รวมวันหยุดเสาร์-อาทิตย์ และวันหยุดนักขัตฤกษ์นะครับ 📄"
`.trim();
...
// ─────────────────────────────────────────────────────────────────
// ตรวจว่า bot ตอบว่าจะติดต่อเจ้าหน้าที่ = out-of-scope
const OUT_OF_SCOPE_PATTERN = /น้องต่อกันติดต่อเจ้าหน้าที่|ให้บริการเฉพาะเรื่องประกัน|นอกเหนือจากขอบเขต/i;
